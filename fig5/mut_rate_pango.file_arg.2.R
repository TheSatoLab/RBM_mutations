...
# install.packages("https://cran.r-project.org/src/contrib/Archive/dplyr/dplyr_1.0.5.tar.gz",repos = NULL)
library(dplyr)
library(ggplot2)
#sessionInfo()
...
metadata_filtered <- metadata %>% filter(Host=="Human") %>% select(5,14,6)
