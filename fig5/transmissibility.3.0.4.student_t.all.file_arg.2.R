...
txt.mut_mat_out.name <- paste(out.prefix, "/method3.spike_hap.student_t.",date.start, "_", date.end, ".",region.interest,".mut_mat.txt", sep="")
# txt.growth.rate.name <- paste(out.prefix,"/method3.spike_hap.student_t.",date.start, "_", date.end, ".",region.interest,".tree_", tree.depth ,".bin_", bin.size ,".growth_rate.txt", sep="")
# txt.growth.gain.name <- paste(out.prefix,"/method3.spike_hap.student_t.",date.start, "_", date.end, ".",region.interest,".tree_", tree.depth ,".bin_", bin.size ,".growth_gain.txt", sep="")
